...
BLOG_AUTHOR = "Julien Berger"  # (translatable)
BLOG_TITLE = "Julien Berger"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://julien.berger.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://julien.berger.com/"
BLOG_EMAIL = "berger.julien@hotmail.com"
BLOG_DESCRIPTION = "Berger Julien web page"  # (translatable)
